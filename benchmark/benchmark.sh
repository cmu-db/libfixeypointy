...
UTIL_DIR=$PROJECT_DIR/benchmark
...
python3 $SCRIPT_DIR/tools/data_gen_v2.py -l $BENCH_LEN -o $BENCH_INPUT
python3 $SCRIPT_DIR/tools/data_gen_v2.py -l $BENCH_LEN -b 7 -o $BENCH_MAGIC_INPUT
...
# Python Decimal
python3 $UTIL_DIR/python_decimal_v2.py -m add -t $RUNS -s $SKIP -i $BENCH_ITER -b $BENCH_INPUT > $BENCH_DIR/$PY_PREFIX-add.csv
python3 $UTIL_DIR/python_decimal_v2.py -m sub -t $RUNS -s $SKIP -i $BENCH_ITER -b $BENCH_INPUT > $BENCH_DIR/$PY_PREFIX-sub.csv
python3 $UTIL_DIR/python_decimal_v2.py -m mlt -t $RUNS -s $SKIP -i $BENCH_ITER -b $BENCH_INPUT > $BENCH_DIR/$PY_PREFIX-mlt.csv
python3 $UTIL_DIR/python_decimal_v2.py -m div -t $RUNS -s $SKIP -i $BENCH_ITER -b $BENCH_INPUT > $BENCH_DIR/$PY_PREFIX-div.csv
python3 $UTIL_DIR/python_decimal_v2.py -m mlt -t $RUNS -s $SKIP -i $BENCH_ITER -b $BENCH_MAGIC_INPUT > $BENCH_DIR/$PY_PREFIX-$MAGIC_PREFIX-mlt.csv
python3 $UTIL_DIR/python_decimal_v2.py -m div -t $RUNS -s $SKIP -i $BENCH_ITER -b $BENCH_MAGIC_INPUT > $BENCH_DIR/$PY_PREFIX-$MAGIC_PREFIX-div.csv

# Java BigDecimal
cd $UTIL_DIR
javac $UTIL_DIR/JavaBigDecimal.java
java JavaBigDecimal add $RUNS $SKIP $BENCH_ITER $BENCH_INPUT > $BENCH_DIR/$JAVA_PREFIX-add.csv
java JavaBigDecimal sub $RUNS $SKIP $BENCH_ITER $BENCH_INPUT > $BENCH_DIR/$JAVA_PREFIX-sub.csv
java JavaBigDecimal mlt $RUNS $SKIP $BENCH_ITER $BENCH_INPUT > $BENCH_DIR/$JAVA_PREFIX-mlt.csv
java JavaBigDecimal div $RUNS $SKIP $BENCH_ITER $BENCH_INPUT > $BENCH_DIR/$JAVA_PREFIX-div.csv
java JavaBigDecimal mlt $RUNS $SKIP $BENCH_ITER $BENCH_MAGIC_INPUT > $BENCH_DIR/$JAVA_PREFIX-mlt.csv
java JavaBigDecimal div $RUNS $SKIP $BENCH_ITER $BENCH_MAGIC_INPUT > $BENCH_DIR/$JAVA_PREFIX-div.csv
