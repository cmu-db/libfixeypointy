...
std::unordered_map<uint128_t, MagicNumber128, Unsigned128BitHash>
    magic_map128_bit_constant_division = {{5, {0xcccccccccccccccc, 0xcccccccccccccccd, 130, 0}},
                                                               {7, {0x2492492492492492, 0x4924924924924925, 131, 1}}};

/** Magic numbers for 256-bit division with specific constants. */
std::unordered_map<uint128_t, MagicNumber256, Unsigned128BitHash>
    magic_map256_bit_constant_division = {
